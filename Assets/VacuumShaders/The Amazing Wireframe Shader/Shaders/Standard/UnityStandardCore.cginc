...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
	...
	SetupWireframe(i.mass.xyz, float2(i.posWorld.w, i.mass.w), i.posWorld.xyz, i.tangentToWorldAndParallax[2], s.diffColor, s.alpha, wireEmission);
...
//#if defined(_PARALLAXMAP)
	half4 viewDirForParallax			: TEXCOORD8;	//xyz - posWorld, real paralax is not used
//#endif
...
VertexOutputForwardAdd vertForwardAdd (VertexInput v)
{
	...
	#ifdef _PARALLAXMAP
		TANGENT_SPACE_ROTATION;
		o.viewDirForParallax.xyz = mul (rotation, ObjSpaceViewDir(v.vertex));
	#endif
...
//	#endif
	...
	float3 mass : TEXCOORD8; //xyz - Wireframe mass
	float2 uv : TEXCOORD9;	//Wireframe Texture uv
...
)
{
	...
	//Wireframe ///////////////////////////////////////////////////////////////////////////////////////////
	float3 wireEmission = 0;
	SetupWireframe(i.mass.xyz, i.uv, i.posWorld.xyz, i.tangentToWorldAndParallax[2], s.diffColor, s.alpha, wireEmission);
	...
	#ifdef _EMISSION 
		color += Emission (i.tex.xy) + float4(wireEmission, 1);
	#endif 
